...
namespace NW_Central_Library.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(LibProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,InActive,InActiveDate")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,InActive,InActiveDate")] Publisher publisher)
        {
            if (id != publisher.Id)
            {
                return NotFound();
