...
namespace NW_Central_Library.Controllers
{
    public class PhonesController : Controller
    {
        ...
        public PhonesController(LibProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,PhoneNum,InActive,InActiveDate")] Phone phone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PhoneNum,InActive,InActiveDate")] Phone phone)
        {
            if (id != phone.Id)
            {
                return NotFound();
