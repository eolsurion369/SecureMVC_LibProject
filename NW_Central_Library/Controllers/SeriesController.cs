...
namespace NW_Central_Library.Controllers
{
    public class SeriesController : Controller
    {
        ...
        public SeriesController(LibProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,InActive,InActiveDate")] Series series)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,InActive,InActiveDate")] Series series)
        {
            if (id != series.Id)
            {
                return NotFound();
