...
namespace NW_Central_Library.Controllers
{
    public class EmailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Addr,InActive,InActiveDate")] Email email)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Addr,InActive,InActiveDate")] Email email)
        {
            if (id != email.Id)
            {
                return NotFound();
