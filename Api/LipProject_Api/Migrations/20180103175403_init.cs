        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountLockout = table.Column<bool>(nullable: true),
                    PWExpirationDate = table.Column<DateTime>(type: "date", nullable: false),
                    PWUpdateDate = table.Column<DateTime>(type: "date", nullable: false),
                    UserPW = table.Column<string>(unicode: false, maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryLogin", x => x.UserID);
                });
